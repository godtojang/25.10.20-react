...
// 함수의 이름을 이용하여 다른 변수에 대입할 수 있음
// 함수의 이름에는 함수를 가리키는 참조 값이 들어있음
const fn = add;
...
// 즉, 함수도 숫자, 문자열과 같이 "데이터"처럼 사용할 수 있음
...
// repeat은 "반복한다" 라는 공통 구조를 가지고 있음
// 각 반복마다 무엇을 할 지는 콜백으로부터 외부에 위임을 한 구조
...
// "설정 값을 기억하는 함수" 와 같은 방식으로 실무에서는 많이 쓰임
...
// 객체 배열에서 age >= minAge인 사람만 남기는 필터 함수를 반환
const users = [
  { name: "A", age: 15 },
  { name: "B", age: 20 },
  { name: "C", age: 30 },
